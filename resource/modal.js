...
function setMember(select_chara_no, style_id, isTrigger) {
    ...
    // 画像切り替え
    let temp_1 = style_info.image_url.split(".");
    let temp_2 = temp_1[0] + "_Thumbnail.webp?v=/";

    $('#select_chara_' + select_chara_no).attr("src", "icon/" + temp_2);
...
function removeMember(select_chara_no, isTrigger) {
    ...
    // 画像初期化
    $('#select_chara_' + select_chara_no).attr("src", "resource/plus.png");
    if (isTrigger) {
        $("#attack_list").trigger("change");
    }
}
...
function setSubMember(sub_chara_no, style_id) {
    ...
    let temp1 = style_info.image_url.split(".");
    let temp2 = temp1[0] + "_Thumbnail.webp?v=/";
// 画像切り替え
    $('#sub_chara_' + sub_chara_no).attr("src", "icon/" + temp2);
...
function removeSubMember(sub_chara_no) {
    // 画像初期化
    $('#sub_chara_' + sub_chara_no).attr("src", "resource/cross.png");
